...
type Datum struct {
	...
	OrigKnowledgePointsLinks []OrigKnowledgePointsLink `json:"orig_knowledge_points_links"`
}

type OrigKnowledgePointsLink struct {
	Img  string `json:"img"`
...
func reqAPI(q *question) (error, *question) {
	...
	req, err := http.NewRequest("GET", "http://127.0.0.1:1107/search/api/v1.0/questions", nil)
